...
def main():
    validate_buildtimes_for_domain('covid19-dev.tistatech.com')
    res = validate_buildtimes_for_domain('covid19-demo.tistatech.com') \
        + validate_buildtimes_for_domain('covid19-internal.tistatech.com') \
        + validate_buildtimes_for_domain('covid19.tistatech.com')
    return 0

...
CREATE TABLE covid_data (
    ...
    state_id TEXT,
    fips TEXT,
    confirmed INTEGER NOT,
    deaths INTEGER NOT,
    recovered INTEGER NOT,
    active INTEGER NOT,
    geo_lat DECIMAL,
    geo_long DECIMAL,
    note TEXT,
    ...
    vaccination_distributed INTEGER,
    vaccination_administered INTEGER,
    vaccination_adm_dose1 INTEGER,
    vaccination_adm_dose2 INTEGER,
